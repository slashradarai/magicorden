...
export const content = {
  es: {
    ...
    blog: {
      metaTitle: 'Blog | Magic Orden',
      metaDescription: 'Ideas y métodos de organización para tu hogar en Valencia. Armarios, despensas, mudanzas y hábitos que duran.',
      eyebrow: 'Ideas y método',
      title: 'El blog',
      intro: 'Cómo pensar el orden en casa, explicado sin prisa.',
      empty: 'Todavía no hay artículos publicados. Vuelve pronto.',
      back: 'Volver al blog',
      published: 'Publicado',
      updated: 'Actualizado',
      faqTitle: 'Preguntas frecuentes',
      ctaTitle: '¿Quieres ayuda con tu casa?',
      ctaBody: 'Reserva una consulta o escríbeme y lo vemos juntas.',
      readMore: 'Leer',
